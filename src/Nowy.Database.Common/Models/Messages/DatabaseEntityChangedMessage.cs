...
public class DatabaseEntityChangedMessage : IEquatable<DatabaseEntityChangedMessage>
{
    ...
    public bool Equals(DatabaseEntityChangedMessage? other)
    {
        ...
        return this.DatabaseName == other.DatabaseName && this.EntityName == other.EntityName && this.Id == other.Id;
    }
    ...
    {
        return HashCode.Combine(this.DatabaseName, this.EntityName, this.Id);
    }
}
